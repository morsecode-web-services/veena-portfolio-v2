          ...
          <div className="max-w-md w-full bg-red-50 border border-red-200 rounded-lg p-6 text-center text-red-900">
            ...
            {error && (
              <details className="text-left mb-4">
                ...
                <pre className="mt-2 text-[10px] text-red-800 bg-red-100 p-2 rounded overflow-auto max-h-32 font-mono">
                  {error.message}
                </pre>
              </details>
            )}
            <button
              ...
              className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-xs font-bold uppercase tracking-widest"
            >
              Try Again
            </button>
          </div>
      ...
      fallback={
        <div className="py-12 px-4 text-center">
          <div className="max-w-md mx-auto bg-gray-50 border border-gray-200 rounded-lg p-6">
            <p className="text-gray-700 mb-2">Unable to load the {sectionName} section</p>

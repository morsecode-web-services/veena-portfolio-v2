      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            />
            {errors.date && (
              <p className="mt-1 text-sm text-red-500 font-medium">{errors.date.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.venue && (
              <p className="mt-1 text-sm text-red-500 font-medium">{errors.venue.message}</p>
            )}
          </div>
          ...
          <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl border border-gray-100 h-fit self-end">
            ...
            <label
              ...
              className="text-sm font-bold text-navy-900 cursor-pointer select-none uppercase tracking-wide"
            >
      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            />
            {errors.booking_url && (
              <p className="mt-1 text-sm text-red-500 font-medium">{errors.booking_url.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.map_url && (
              <p className="mt-1 text-sm text-red-500 font-medium">{errors.map_url.message}</p>
            )}
          </div>
          ...
          <div className="md:col-span-2">
            ...
            {errors.image_url && (
              <p className="mt-1 text-sm text-red-500 font-medium">{errors.image_url.message}</p>
            )}
          </div>
        </div>
      </div>

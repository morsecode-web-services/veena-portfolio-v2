    ...
    <BubbleMenu>
      <div className="bg-navy-950 text-white rounded-lg shadow-xl p-1 flex items-center gap-0.5 border border-navy-800">
        ...
        <button
          type="button"
          onClick={() => editor.chain().focus().toggleUnderline().run()}
          className={`p-1.5 rounded hover:bg-navy-800 transition-colors ${editor.isActive('underline') ? 'text-gold-400' : 'text-navy-100'}`}
        >
    ...
    <div className="border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm ring-1 ring-black/5">
      <EditorProvider
        ...
        editorProps={{
          attributes: {
            class:
              'prose prose-lg prose-navy max-w-none focus:outline-none min-h-[400px] px-4 py-8 bg-white font-serif',
          },
        }}

                    ...
                    <div className="space-y-2 border-t border-slate-100 pt-4">
                        ...
                        {lastSaved && (
                            <div className="flex items-center justify-between pt-1 border-t border-dashed border-slate-100">
                                ...
                                <span className="text-[10px] text-slate-850 font-medium">{format(lastSaved, 'h:mm a')}</span>
                            </div>
                        )}
                    </div>
                ...
                <div className="bg-slate-50 border-t border-slate-200 p-3 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <label htmlFor="is_published" className="text-xs font-bold text-slate-700 cursor-pointer select-none uppercase tracking-wider">
                                Publish Post
                            </label>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded border border-slate-200 p-5 space-y-4 shadow-none">
                    ...
                    >
                        <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider border-b border-slate-200 pb-2.5 flex items-center justify-between">
                            ...
                            {showSeo ? <ChevronUp className="h-3.5 w-3.5 text-slate-400" /> : <ChevronDown className="h-3.5 w-3.5 text-slate-400" />}
                        </h3>
                    </button>
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {keywords.map((kw, i) => (
                                            <span key={i} className="inline-flex items-center gap-1 px-2 py-0.5 bg-slate-100 text-slate-700 text-[9px] font-bold uppercase rounded border border-slate-200">
                                                {kw}
                                                <button onClick={() => removeKeyword(i)} type="button" className="focus:outline-none">

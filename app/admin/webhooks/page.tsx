...
export default function WebhookDashboard() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on(
        'postgres_changes',
        { event: 'INSERT', table: 'webhook_logs', schema: 'public' },
        (payload) => {
          setLogs((prev) => {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-200 pb-4">
        <div>
          ...
          <p className="text-slate-500 text-xs mt-0.5">
            Execution logs and pipeline settings for webhook integrations.
          </p>
        </div>
              ...
              <div className="bg-white rounded border border-slate-200 overflow-hidden">
                {loading && logs.length === 0 ? (
                  <div className="p-12 flex flex-col items-center justify-center text-slate-400 gap-4">
                    ...
                    <p className="font-medium animate-pulse uppercase tracking-widest text-[10px]">
                      Loading logs...
                    </p>
                  </div>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            ...
                            {getNotificationBadge(
                              'WA (Twilio)',
                              log.notification_status?.twilio_whatsapp
                            )}
                          </div>
                        </div>
                        <ChevronRight
                          className={`h-3.5 w-3.5 text-slate-300 transition-transform ${selectedLog?.id === log.id ? 'translate-x-0.5 text-slate-500' : 'group-hover:translate-x-0.5'}`}
                        />
                      </button>
                    ))}
                  </div>
                ...
                {selectedLog ? (
                  ...
                  >
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="p-3 bg-slate-50 rounded border border-slate-200">
                            <div className="flex items-center justify-between mb-2">
                              ...
                              {getNotificationBadge(
                                '',
                                selectedLog.notification_status?.twilio_whatsapp
                              )}
                            </div>
                    ...
                    <div className="p-4 bg-slate-50 border-t border-slate-200">
                      <button
                        ...
                        onClick={() =>
                          alert(
                            'Manual retry functionality coming soon. You can trigger it via Postman/curl using the payload above.'
                          )
                        }
                      >
                  ...
                  <div className="h-full flex flex-col items-center justify-center p-12 text-center bg-white rounded border border-dashed border-slate-200">
                    ...
                    <p className="text-xs text-slate-500">
                      Select an execution from the list to view delivery details and raw payment
                      data.
                    </p>
                  </div>
                )}
            ...
            <div className="bg-white rounded border border-slate-200 overflow-hidden">
              <div className="p-5 border-b border-slate-200 bg-slate-50">
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Enable or disable specific automation channels globally.
                </p>
              </div>
              ...
              <div className="divide-y divide-slate-100">
                ...
                <div className="p-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-500 mt-0.5">
                        Sends the private invite link via email immediately after payment.
                      </p>
                    </div>
                  </div>
                  <button
                    ...
                    onClick={() =>
                      saveSettings({ ...settings, email_enabled: !settings.email_enabled })
                    }
                  ...
                  >
                    <span
                      className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform ${settings.email_enabled ? 'translate-x-4' : 'translate-x-1'}`}
                    />
                  </button>
                </div>
                ...
                <div className="p-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-500 mt-0.5">
                        Generates a unique link. If disabled, email/WA won&apos;t be sent as they
                        require the link.
                      </p>
                    </div>
                  </div>
                  <button
                    disabled={savingSettings}
                    onClick={() =>
                      saveSettings({ ...settings, telegram_enabled: !settings.telegram_enabled })
                    }
                  ...
                  >
                    <span
                      className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform ${settings.telegram_enabled ? 'translate-x-4' : 'translate-x-1'}`}
                    />
                  </button>
                </div>
                ...
                <div className="p-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-500 mt-0.5">
                        Sends the invite link via Meta Cloud API. (Requires approved template)
                      </p>
                    </div>
                  </div>
                  <button
                    disabled={savingSettings}
                    onClick={() =>
                      saveSettings({ ...settings, whatsapp_enabled: !settings.whatsapp_enabled })
                    }
                  ...
                  >
                    <span
                      className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform ${settings.whatsapp_enabled ? 'translate-x-4' : 'translate-x-1'}`}
                    />
                  </button>
                </div>
                ...
                <div className="p-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-500 mt-0.5">
                        Alternative WhatsApp channel. Useful for sandbox testing without Meta
                        approval.
                      </p>
                    </div>
                  </div>
                  <button
                    ...
                    onClick={() =>
                      saveSettings({
                        ...settings,
                        twilio_whatsapp_enabled: !settings.twilio_whatsapp_enabled,
                      })
                    }
                  ...
                  >
                    <span
                      className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform ${settings.twilio_whatsapp_enabled ? 'translate-x-4' : 'translate-x-1'}`}
                    />
                  </button>
                </div>
              </div>
              ...
              <div className="p-4 bg-slate-50 border-t border-slate-200">
                <div className="flex items-start gap-2.5 text-slate-500">
                  ...
                  <p className="text-[11px]">
                    Changes take effect immediately for all future incoming payments. Make sure your
                    API keys in <code>.env.local</code> are correct before enabling WhatsApp.
                  </p>
                </div>
              </div>
            </div>

    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
        <div>
          ...
          <p className="text-slate-500 text-xs mt-0.5">
            Manage cohort access keys, reminders, and community onboarding.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-4">
          ...
          <span
            className={`text-xl font-bold block mt-1 ${stats.pendingTelegram > 0 ? 'text-amber-600' : 'text-slate-800'}`}
          >
              ...
              {results.length > 0 ? (
                        ...
                        <tr key={student.email} className="hover:bg-slate-50/50 transition-colors">
                          ...
                          <td className="px-5 py-3">
                            ...
                            <div className="text-[10px] text-slate-400 mt-0.5 space-y-0.5">
                              ...
                              {(() => {
                                const tgCohort = student.cohorts.find(
                                  (c) => c.telegram_username || c.telegram_display_name
                                );
                                if (!tgCohort) return null;
                                const username = tgCohort.telegram_username
                                  ? `@${tgCohort.telegram_username.replace('@', '')}`
                                  : '';
                              ...
                              {student.cohorts.map((cohort) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <span
                                      className={`px-1.5 py-0.5 text-[8px] font-bold border rounded uppercase tracking-wider ${
                ...
                <div className="p-8 text-center text-slate-400">
                  ...
                  <p className="text-[10px] text-slate-400 mt-0.5">
                    Double check the spelling or filter settings.
                  </p>
                </div>
              ) : (
            ...
            {unjoinedLoading ? (
                        ...
                        return (
                          <tr key={cohort.id} className="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td className="px-5 py-3">
                              ...
                              <span className="ml-2 text-[9px] bg-red-50 text-red-700 border border-red-100 px-1.5 py-0.5 rounded font-medium uppercase">
                                Not Joined
                              </span>
                            </td>
              ...
              <div className="p-12 text-center text-slate-500 bg-slate-50/50">
                ...
                <p className="text-xs font-semibold text-slate-800">
                  All students are in Telegram! 🎉
                </p>
                <p className="text-[10px] text-slate-400 mt-0.5">
                  Every active student has successfully joined the Telegram group for their cohort.
                </p>
              </div>
            )}
          </div>
              ...
              {generatedLink ? (
                <div className="space-y-4">
                  <div className="bg-emerald-50 text-emerald-800 border border-emerald-100 rounded p-4 text-center space-y-2">
                    ...
                    <p className="text-[10px] text-emerald-700/80">
                      Expires in {inviteExpireHours} hours.
                    </p>

                    <div className="flex items-center gap-1.5 bg-white border border-emerald-100 rounded p-2 shadow-inner select-all">
                      <span className="text-[10px] font-mono text-slate-700 truncate flex-grow text-left">
                        {generatedLink}
                      </span>
                      <button
                ...
                <form onSubmit={handleGenerateInvite} className="space-y-4">
                  ...
                  <div className="flex items-center gap-2 p-2.5 bg-slate-50 rounded border border-slate-200">
                    ...
                    />
                    <label
                      htmlFor="recordEnrollment"
                      className="text-[11px] text-slate-700 cursor-pointer select-none"
                    >

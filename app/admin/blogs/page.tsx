        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white p-4 rounded border border-slate-200 shadow-none">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Total Posts</p>
                ...
                <div className="bg-white p-4 rounded border border-slate-200 shadow-none">
                    ...
                    <p className="text-xl font-bold text-emerald-600">{blogs.filter(b => b.is_published).length}</p>
                </div>
                <div className="bg-white p-4 rounded border border-slate-200 shadow-none">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Drafts</p>
                    <p className="text-xl font-bold text-amber-600">{blogs.filter(b => !b.is_published).length}</p>
                </div>
            </div>
                                    ...
                                    <tr key={blog.id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-4 py-3">
                                            <button
                                                ...
                                                className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider border ${blog.is_published
